...
var lyr_Isochrones_1 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Isochrones<br />\
    <img src="styles/legend/Isochrones_1_0.png" /> 10 min<br />' });
var format_ParkandRecreationFacilities_2 = new ol.format.GeoJSON();
var features_ParkandRecreationFacilities_2 = format_ParkandRecreationFacilities_2.readFeatures(json_ParkandRecreationFacilities_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ParkandRecreationFacilities_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ParkandRecreationFacilities_2.addFeatures(features_ParkandRecreationFacilities_2);
var lyr_ParkandRecreationFacilities_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ParkandRecreationFacilities_2, 
                style: style_ParkandRecreationFacilities_2,
                popuplayertitle: 'ParkandRecreationFacilities',
                interactive: true,
                title: 'ParkandRecreationFacilities'
            });
var format_CityLimitsCountyBoundary_3 = new ol.format.GeoJSON();
var features_CityLimitsCountyBoundary_3 = format_CityLimitsCountyBoundary_3.readFeatures(json_CityLimitsCountyBoundary_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CityLimitsCountyBoundary_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CityLimitsCountyBoundary_3.addFeatures(features_CityLimitsCountyBoundary_3);
var lyr_CityLimitsCountyBoundary_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CityLimitsCountyBoundary_3, 
                style: style_CityLimitsCountyBoundary_3,
